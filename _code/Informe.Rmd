...
La base de datos tiene 160,795 registros, inicialmente se la tenía en formato Excel, se transformó a CSV, para luego tratarla con SPARK, con excelentes resultados.

No se requirió realizar ningún tratamiento a los registros.

## 3. Visualización de la información

El presente proyecto se presenta mediante la visualización de un Dashboard y un informe en pdf.

## 4. Armado de la plataforma

El armado de los gráficos se realizó utilizando la librería Flexdashboard
