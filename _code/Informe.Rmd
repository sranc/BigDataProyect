...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN (ESTRUCTURA DEL PRESUPUESTO)|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN POR REGIÓN|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN POR DEPARTAMENTO|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN POR DEPARTAMENTO Y MUNICIPIO|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN POR TIPO DE SECTOR Y TIPO DE PROYECTO|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN POR TIPO DE SECTOR Y SIGLA DE ENTIDAD|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN POR TIPO DE SECTOR Y TIPO DE ENTIDAD|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN POR TIPO DE SECTOR, TIPO DE RECURSO Y TIPO DE FINANCIAMIENTO|
|-----|-----|
...
|INDICADOR|PRESUPUESTO PROGRAMADO VS PRESUPUESTO EJECUTADO POR SECTOR ECONÓMICO, % DE EJECUCIÓN POR TIPO DE SECTOR Y DEPARTAMENTO|
|-----|-----|
